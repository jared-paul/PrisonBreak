...
public class CommandManager implements CommandExecutor
{
    ...
    private void executeMethod(CommandSender sender, CommandInfo commandInfo) throws CommandException
    {
        ...
        {
            PrisonBreak.LOG.warning("COMMAND ERROR: Failed to execute command");
            e.printStackTrace();
        }
    }
    ...
    private boolean suggestClosestModifier(CommandSender sender, CommandInfo commandInfo)
    {
        ...
        if (!closest.isEmpty())
        {
            PrisonBreak.LOG.debug(closest);
            PrisonBreak.LOG.severe(commandInfo.root);
    ...
    public String getClosestCommandModifier(CommandInfo commandInfo)
    {
        ...
        PrisonBreak.LOG.warning(closest);
        return closest;
    }
    ...
    private boolean suggestClosestRoot(CommandSender sender, CommandInfo command)
    {
        ...
        if (!closest.isEmpty())
        {
            PrisonBreak.LOG.severe(closest);
            PrisonBreak.LOG.warning(command.root);
            sender.sendMessage(ChatColor.RED + "Unknown command");
    ...
    {
        PrisonBreak.LOG.debug(commands.toString());
